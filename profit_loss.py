...
def profitloss():
    ...
    if pl_max_decrement_index > 0:
        pl_determine_print = 1
    elif pl_max_decrement_index < 0 and pl_max_increment_index > 0:
        pl_determine_print = 3
    else:
        pl_determine_print = 2

    pl_result.append(('pl_determine_print', pl_determine_print))
